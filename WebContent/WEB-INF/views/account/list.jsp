...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            <label>顾客名称:</label><input id="search-name" class="wu-text" style="width:100px">
	...
	<form id="add-form" method="post">
        <table>
            <tr>
                ...
                <td><input type="text" id="add-name" name="name" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写顾客名称'" /></td>
            </tr>
             <tr>
                <td align="right">密码:</td>
                <td><input type="password" id="add-password" name="password" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写顾客密码'" /></td>
            </tr>
            <tr>
...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px; padding:10px;">
	<form id="edit-form" method="post">
        ...
        <table>
           <tr>
                <td align="right">名称:</td>
                <td><input type="text" id="edit-name" name="name" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写顾客名称'" /></td>
            </tr>
             <tr>
                <td align="right">密码:</td>
                <td><input type="password" id="edit-password" name="password" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写顾客密码'" /></td>
            </tr>
            <tr>
                <td align="right">真实姓名:</td>
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
            ...
            { field:'photo',title:'顾客图片',width:100,align:'center',formatter:function(value,row,index){
