	...
	<form id="add-form" method="post">
        <table>
            <tr>
                ...
                <td>
	                <select id="add-accountId" name="accountId" class="easyui-combobox" panelHeight="auto" style="width:268px" data-options="required:true, missingMessage:'请选择顾客'">
		            	<c:forEach items="${accountList}" var="account">
	...
	<form id="edit-form" method="post">
        ...
        <table>
           <tr>
                <td align="right">顾客:</td>
                <td>
	                <select id="edit-accountId" name="accountId" class="easyui-combobox" panelHeight="auto" style="width:268px" data-options="required:true, missingMessage:'请选择顾客'">
		            	<c:forEach items="${accountList}" var="account">
		            	<option value="${account.id }" real-name="${account.realName }" id-card="${account.idCard }" mobile="${account.mobile }">${account.name }</option>
		            	</c:forEach>
	            	</select>	
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'accountId',title:'顾客',width:100,formatter:function(value,row,index){
