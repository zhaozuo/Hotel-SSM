...
<head>
  ...
  <meta name="Description" content="酒店管理系统">
    ...
    <link rel="stylesheet" type="text/css" href="../../resources/home/css/order.css">
    <link rel="stylesheet" type="text/css" href="../../resources/home/css/jquery-ui.min.css">
</head>
<body>
<!--- 页头--->
<div id="c_header"></div>
...
<div id="section">
    ...
    <div class="book_info">
        <form id="order_info">
            <ul>
                ...
                <li>
                    <div class="msg">
                        预订须知:请携带好本人的身份证，办理入住手续，本店办理入住需要在前台缴费押金 ￥100
                    </div>
    ...
    <div class="malog">
        <div class="message">
            <p class="msgs"></p>
            <p>系统会在<span class="num">2</span>秒后跳转到 <a href="../index">订单列表</a></p>
        </div>
    </div>
