...
<body>
    ...
    <div id="contain">
      ...
      <div class="content">
        ...
        <div class="photo" >
              <form id="upload-photo-form" action="../account/savePhoto" method="post">
                  <table style="border:0px;cellspacing:0px;">
                      <tbody>
                      <tr>
                          <td width="60" align="right">图片预览:</td>
                          <td valign="middle">
                              <img id="preview-photo" style="float:left;" src="/HotelSSM/resources/admin/easyui/images/user_photo.png" width="100px">
                              <a style="float:left;margin-top:40px;" href="javascript:void(0)" class="easyui-linkbutton" onclick="uploadMyPhoto()" plain="true">上传图片</a>
                          </td>
                      </tr>
                      <tr>
                          <td width="60" align="right">用户图片:</td>
                          <td><input type="text" id="add-photo" name="photo" value="/HotelSSM/resources/admin/easyui/images/user_photo.png" readonly="readonly" /></td>
                      </tr>
                      </tbody>
                  </table>
                  <input type="text" id="accountId" name="accountId" value="${account.id}" style="display: none"/>
                  <input type="submit" value="提交" alt="提交"/>
              </form>
          </div>
		<div class="pwd" >
          <table style="border:0px;cellspacing:0px;">
