	...
	<form id="add-form" method="post">
        <table>
            ...
            <tr>
                ...
                <td><input type="text" id="add-photo" name="photo" value="/HotelSSM/resources/admin/easyui/images/user_photo.png" readonly="readonly" class="wu-text " /></td>
            </tr>
            <tr>
	...
	<form id="edit-form" method="post">
        ...
        <table>
           <tr>
                <td width="60" align="right">图片预览:</td>
                <td valign="middle">
                	<img id="edit-preview-photo" style="float:left;" src="/HotelSSM/resources/admin/easyui/images/user_photo.png" width="100px">
                	<a style="float:left;margin-top:40px;" href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-upload" onclick="uploadPhoto()" plain="true">上传图片</a>
                </td>
            </tr>
            <tr>
                <td width="60" align="right">房型图片:</td>
                <td><input type="text" id="edit-photo" name="photo" value="/HotelSSM/resources/admin/easyui/images/user_photo.png" readonly="readonly" class="wu-text " /></td>
            </tr>
           <tr>
                <td align="right">名称:</td>
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'availableNum',title:'可用房间数',width:100,sortable:true},
